...
import { Card, CardHeader, CardContent, Stack, TextField, Button, Grid, Alert, Table, TableHead, TableRow, TableCell, TableBody, IconButton } from '@mui/material';
      ...
      <CardContent>
        <Stack spacing={1.25}>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={12}>
              <Button variant="contained" type="submit" disabled={saving || !email}>Add to whitelist</Button>
            </Grid>
          </Grid>
          <Table size="small">
            <TableHead>
